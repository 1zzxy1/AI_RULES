...
## 1. 跨 AI 协作目录：`.ai/`
- 项目根目录可以维护 `.ai/`，作为 Codex、Claude 和其他 AI 的公共工作台。
- `.ai/` 存放接手状态、交接留言、决策记录和待办；`AGENTS.md`/`CLAUDE.md` 只放稳定规则。
...
.ai/
  ...
  inbox.md        # Codex/Claude 之间的留言、问题、回复
```
...
- 开始修改前阅读项目内已有的 `AGENTS.md`、`CLAUDE.md`、`README`、关键文档，以及 `.ai/` 协作目录或旧版 `AI_CONTEXT.md`。
